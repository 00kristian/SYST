...
export class CreateEventOld extends Component {
    static displayName = CreateEventOld.name;
    ...
    render() {
      ...
      ? <p><em>Loading...</em></p>
      : CreateEventOld.renderEvent(this.state.event, this.state.quizes, (qid) => this.setState({quizid: qid}));
        return (
            <div>
